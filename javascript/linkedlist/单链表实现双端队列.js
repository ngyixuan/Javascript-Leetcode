...
class dequeueArray {
  ...
  addFirst(val) {
    this.linklist.addFirst(val);
  }

  addLast(val) {
    this.linklist.addLast(val);
  }
  ...
  removeLast() {
    return this.linklist.removeLast();
  }
  ...
  peekLast() {
    return this.linklist.getLast();
  }
}

let dequeueArr = new dequeueArray();
dequeueArr.addFirst(1);
dequeueArr.addLast(2);
dequeueArr.addLast(3);
